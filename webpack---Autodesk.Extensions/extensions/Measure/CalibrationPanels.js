...
export var CalibrationPanel = function(calibrationTool, viewer, id, title, options) {
    ...
    this.units = [{
            ...
            matches: ['ft-and-fractional-in', 'fractional-in'],
            simpleInput: false
        },
        {
            name: 'Feet and decimal inches',
            units: 'ft-and-decimal-in',
            matches: ['ft', 'decimal-ft', 'in', 'decimal-in', 'ft-and-decimal-in'],
            simpleInput: false
        },
        {
            name: 'Meters',
    ...
    this.unitList = new avp.OptionDropDown("Unit type", this.tbody, unitNames, 0, null, undefined, {
        paddingLeft: 0,
        paddingRight: 0
    });
