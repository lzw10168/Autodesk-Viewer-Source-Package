...
proto.init = function() {
    ...
    this.unitList = new avp.OptionDropDown("Unit type", this.tbody, unitNames, initialIndex, null, {
        paddingLeft: 0,
        paddingRight: 15
    });
    ...
    this.precisionList = new avp.OptionDropDown("Precision", this.tbody, [], -1, null, {
        paddingLeft: 0,
        paddingRight: 15
    });
