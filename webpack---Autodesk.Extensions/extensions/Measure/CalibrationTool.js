...
export var CalibrationTool = function(viewer, options, sharedMeasureConfig, snapper) {
    ...
    this.calibrate = function(requestedUnits, requestedSize) {
        ...
        if (calibrationFactor) {
            ...
            _viewer.dispatchEvent({
                type: MeasureCommon.Events.FINISHED_CALIBRATION,
    ...
    this.hidePanel = function() {
        if (_calibrationPanel) {
            ...
            _viewer.dispatchEvent({
                type: MeasureCommon.Events.CLOSE_CALIBRATION_PANEL_EVENT
            });
        }
    };
    ...
    this.showPanel = function() {
        ...
        if (_calibrationPanel) {
            ...
            _viewer.dispatchEvent({
                type: MeasureCommon.Events.OPEN_CALIBRATION_PANEL_EVENT,
                data: {
                    size: _selectedSize,
    ...
    this.clearSize = function() {
        ...
        if (_calibrationPanel) {
            ...
            _viewer.dispatchEvent({
                type: MeasureCommon.Events.CLEAR_CALIBRATION_SIZE_EVENT
            });
        }
    };
