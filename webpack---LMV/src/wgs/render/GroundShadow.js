...
import {
    FrustumIntersector
} from "../scene/FrustumIntersector";
import {
    LmvBox3 as Box3
} from '../scene/LmvBox3';
import {
    MeshFlags
} from "../scene/MeshFlags";
...
export function GroundShadow(renderer, params) {
    ...
    var _camera;
    const _frustumIntersector = new FrustumIntersector();
    var _scene;
    var _planeMesh;
    ...
    this.setTransform = (function() {
        ...
        return function(center, size, lookDir, upDir) {
            ...
            _camera.orthoScale = size.x;
            _camera.clientHeight = _params.texSize;
            _frustumIntersector.reset(_camera);
            _frustumIntersector.areaCullThreshold = SMALL_FEATURE_CULLING_THRESHOLD;
        };
    })();
    ...
    this.prepareGroundShadow = (function() {
        ...
        return function(modelQueue, minScenesPerFrame, maxTime, ratio) {
            ...
            while ((i < maxScenesPerFrame) && (qSceneIdx < qSceneCount)) {
                ...
                const culled = ENABLE_PIXEL_CULLING && qScene.getBoundingBox && _frustumIntersector.estimateProjectedDiameter(qScene.getBoundingBox()) < _frustumIntersector.areaCullThreshold;
                if (culled) {
                    continue;
                }
