...
export default class SheetRenderContext {
    ...
    createContext() {
        ...
        this.sheetContext.init(this.glRenderer, this.renderContext.settings.logicalWidth, this.renderContext.settings.logicalHeight, {
            offscreen: true
        });
    ...
    createScene() {
        ...
        this.material = new THREE.ShaderMaterial({
            uniforms: {
                sheetMap: {
                    type: 't',
                    value: this.sheetContext.getColorTarget()
                },
                idMap: {
                    type: 't',
                    value: this.sheetContext.getIDTargets()[0]
                },
                modelIDv2: {
                    type: 'v3',
