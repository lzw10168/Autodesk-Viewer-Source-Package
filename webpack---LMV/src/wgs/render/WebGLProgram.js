    ...
    return function(renderer, code, material, parameters, geom) {
        ...
        if (material instanceof THREE.RawShaderMaterial) {
            ...
            prefix_fragment = [
                ...
                parameters.logarithmicDepthBuffer ? "#define USE_LOGDEPTHBUF" : "",
                parameters.logarithmicDepthBuffer ? "#define USE_LOGDEPTHBUF_EXT" : "",
                parameters.logarithmicDepthBuffer && parameters.polygonOffset ? "#define POLYGON_OFFSET" : "",
        ...
        identifiers.push('logDepthBufFC', 'polygonOffset');
