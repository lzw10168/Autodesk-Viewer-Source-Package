    ...
    uniforms: THREE.UniformsUtils.merge([
        ...
        chunks.CutPlanesUniforms,
        {
            ...
            "viewportId": {
                type: "f",
                value: 0.0
            }, // the viewport id of the first selection in measure
            "swap": {
                type: "f",
                value: 0.0
            }, // whether to swap black and white colors
            "grayscale": {
                type: "f",
                value: 0.0
            }, // whether to render all lines in a shade of gray
            "viewportBounds": {
                type: "v4",
                value: new THREE.Vector4(0, 0, 1, 1)
            },
