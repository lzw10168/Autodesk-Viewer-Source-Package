...
import {
    ViewerPanelMixin
} from "./ViewerPanelMixin";
import {
    LightPresetThumbnails
} from "./LightPresetThumbnails";
...
import {
    EnumType
} from "../application/ProfileSettings";
import {
    displayUnitsEnum,
...
export function ViewerSettingsPanel(opts, model) {
    ...
    this.addTab(ViewerSettingTab.Configuration, "Configuration", {
        className: "performance"
    });
    this.addTab(ViewerSettingTab.Navigation, "Navigation", {
        className: "navigation"
    });
    this.addTab(ViewerSettingTab.Appearance, "Appearance", {
        className: "appearance"
    });
    if (this.is3dMode) {
        this.addTab(ViewerSettingTab.Environment, "Environment", {
