...
export function ViewerModelStructurePanel(viewer, userTitle, ops) {
    ...
    if (options.hideSearch) {
        ...
        this.searchbox = new Searchbox(options.container.id + 'ViewerModelStructurePanel' + '-Searchbox', options.container, {
