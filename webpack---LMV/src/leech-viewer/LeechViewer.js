...
export function createLeechViewer(container, config, sharedResources, ViewerClass) {
    ...
    LeechViewer.prototype.uninitialize = function() {
        ...
        // let go of the self-reference in the bound function
        this.originalLoadDocumentNode = null;
        this.loadDocumentNode = ViewerClass.prototype.loadDocumentNode;
            ...
            return new Promise((resolve, reject) => {
                ...
                if (modelItem) {
                    ...
                    this.originalLoadDocumentNode(avDocument, manifestNode, options).then((model) => {
                        ...
                        this.sharedResources.loadedModels[key] = {
                            model,
    ...
    LeechViewer.prototype.cloneModelToViewer = function(model) {
        ...
        const invalidateFunc = () => this.impl.invalidate(false, true, false);
        loadingViewer.addEventListener(Autodesk.Viewing.LOADER_REPAINT_REQUEST_EVENT, invalidateFunc, {
            priority: -1000
        });
        ...
        waitForLoadDone(loadingViewer, modelClone).then(() => {
            ...
            // loading is done, so we don't need to invalidate anymore
            loadingViewer.removeEventListener(Autodesk.Viewing.LOADER_REPAINT_REQUEST_EVENT, invalidateFunc);
        });
