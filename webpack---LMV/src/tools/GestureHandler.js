...
function initGesturesOnce() {
    ...
    gr.singletap = [Hammer.Tap, {
        event: 'singletap',
        threshold: 7.0,
        time: 400
    }];
    gr.singletap2 = [Hammer.Tap, {
        event: 'singletap2',
        pointers: 2,
        threshold: 7.0,
        time: 400
    }];
    gr.press = [Hammer.Press, {
        event: 'press',
        time: 500,
        threshold: 50.0
    }];
    gr.doubletap = [Hammer.Tap, {
        event: 'doubletap',
        taps: 2,
        interval: 300,
        threshold: 6,
    ...
    gr.pinch = [Hammer.Pinch, {
        event: 'pinch',
        pointers: 2,
        enable: true,
        threshold: 0.05
    }];
    gr.rotate = [Hammer.Rotate, {
        event: 'rotate',
        pointers: 2,
        enable: true,
        threshold: 7.0
