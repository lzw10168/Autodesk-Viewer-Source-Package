...
export class OverlayManager {
    ...
    /*
     * Hides or un-hides a scene from the main render
     *
     * @param {string} name - scene identifier
     * @param {boolean} hidden - if true, the scene will not be shown on the main render
     */
    setSceneHiddenFromMainRender(name, hidden) {
        this.impl.overlayScenes[name].hiddenFromMainRender = hidden;
    }
