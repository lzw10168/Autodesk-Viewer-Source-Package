 ...
 */
av.LOADER_REPAINT_REQUEST_EVENT = 'loaderRepaint';
...
av.MODEL_TRANSFORM_CHANGED_EVENT = 'modelTransformChanged',
     ...
     */
    av.MODEL_FRAGMENT_BOUNDING_BOXES_SET_EVENT = 'fragmentBoundingBoxesSet',
 ...
 * @property {object} model - Model data.
 */
av.FRAGMENTS_LOADED_EVENT = 'fragmentsLoaded';
 ...
 * @property {object} model - Model data.
 */
av.FRAGMENTS_UNLOADED_EVENT = 'fragmentsUnloaded';
 ...
 * @property {object} model - Model data.
 */
av.SCENE_UPDATED_EVENT = 'sceneUpdated';
 ...
 * @property {object} model - Model data.
 */
av.REFRESH_CUSTOM_PROPERTIES = 'refreshCustomProperties';
 ...
 * @property {object} model - Model data.
 */
av.REFRESH_CUSTOM_PROPERTIES_VALUES = 'refreshCustomPropertiesValues';