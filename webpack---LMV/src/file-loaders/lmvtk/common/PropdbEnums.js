...
export var AttributeType = {
    ...
    BLOB: 10,
    DbKey: 11,
    /* represents a link to another object in the database, using database internal ID */
    ...
    /* ISO 8601 date */
    GeoLocation: 23,
    /* LatLonHeight - ISO6709 Annex H string, e.g: "+27.5916+086.5640+8850/" for Mount Everest */
...
export var AttributeFlags = {
    afHidden: 1 << 0,
    /* Attribute will not be displayed in default GUI property views. */
    afDontIndex: 1 << 1,
    /* Attribute will not be indexed by the search service. */
    afDirectStorage: 1 << 2,
    /* Attribute is not worth de-duplicating (e.g. vertex data or dbId reference) */
    afReadOnly: 1 << 3 /* Attribute is read-only (used when writing back to the design model, in e.g. Revit) */
};

//Used by property diff
export var RVT_DIM_PROPS_BLACKLISTED = {
    "Dimensions": [
        "Perimeter",
        "Volume",
        "Area",
...
export var IFC_NWD_ITEM_PROPS_BLACKLISTED = {
    "Item": [
        "Source File"
    ]
};
