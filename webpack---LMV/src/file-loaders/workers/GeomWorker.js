import {
    PackFileReader
} from '../lmvtk/common/PackReader';
import {
    readGeometry
} from '../lmvtk/svf/Geoms';
import {
    ErrorCodes
} from '../net/ErrorCodes';
import {
...
export function register(workerMain) {
    workerMain.register("LOAD_GEOMETRY", {
        doOperation: doGeomLoad
    });
}