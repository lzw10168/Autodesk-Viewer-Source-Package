import {
    theExtensionManager
} from "../src/application/ExtensionManager";

import {
    PropertiesManagerExtension
} from "./PropertiesManager/PropertiesManager";
import {
    ViewerSettingsExtension
} from "./ViewerSettings/ViewerSettings";
import {
    ModelStructureExtension
} from "./ModelStructure/ModelStructure";
import {
    NavToolsExtension
} from "./DefaultTools/NavTools";
import {
    ExplodeExtension
} from "./Explode/Explode";
import {
    FullScreenExtension
