var externalExtensions = [
    ...
    {
        src: './extensions/DeveloperTools/index.js',
        ids: [
            'Autodesk.DeveloperTools.AABBoxAccuracyLogger',
            'Autodesk.DeveloperTools.Shortcuts',
            'Autodesk.DeveloperTools.StatisticsOverlay',
            'Autodesk.DeveloperTools.WebGLDrawStatistics',
            'Autodesk.DeveloperTools.WebGLFunctionIntrusion',
            'Autodesk.DeveloperTools.WebGLObjectCounters',
            'Autodesk.DeveloperTools.WebGLResourceSnapshot',
        ],
    },
    {
    ...
    {
        src: './extensions/SmartSection/index.js',
        ids: ['Autodesk.SmartSection'],
    },
    {
    ...
    {
        src: './extensions/CustomProperties/index.js',
        ids: ['Autodesk.CustomProperties'],
    },
    {
        src: './extensions/Grid/Grid.js',
        ids: ['Autodesk.Grid']
    },
    {
        src: './extensions/SubsetLoading/index.js',
        ids: ['Autodesk.SubsetLoading']
    },
    {
        src: './extensions/DataPersistence/persistence.js',
        ids: ['Autodesk.DataPersistence']
    },
    {
        src: './extensions/CADLabeling/index.js',
        ids: ['Autodesk.CADLabeling']
    },
];
